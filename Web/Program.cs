...
// New entities: orphanage / child / parent / social worker / adoption / child-orphanage / adoption-detail
builder.Services.AddScoped<IOrphanageData, OrphanageData>();
builder.Services.AddScoped<IOrphanageBusiness, OrphanageBusiness>();

builder.Services.AddScoped<IChildData, ChildData>();
builder.Services.AddScoped<IChildBusiness, ChildBusiness>();

builder.Services.AddScoped<IParentData, ParentData>();
builder.Services.AddScoped<IParentBusiness, ParentBusiness>();

builder.Services.AddScoped<ISocialWorkerData, SocialWorkerData>();
builder.Services.AddScoped<ISocialWorkerBusiness, SocialWorkerBusiness>();

builder.Services.AddScoped<IAdoptionData, AdoptionData>();
builder.Services.AddScoped<IAdoptionBusiness, AdoptionBusiness>();

builder.Services.AddScoped<IChildOrphanageData, ChildOrphanageData>();
builder.Services.AddScoped<IChildOrphanageBusiness, ChildOrphanageBusiness>();

builder.Services.AddScoped<IAdoptionDetailData, AdoptionDetailData>();
builder.Services.AddScoped<IAdoptionDetailBusiness, AdoptionDetailBusiness>();
...
builder.Services.AddAutoMapper(cfg => {
    ...
    cfg.AddProfile<OrphanageProfile>();
    cfg.AddProfile<ChildProfile>();
    cfg.AddProfile<ParentProfile>();
    cfg.AddProfile<SocialWorkerProfile>();
    cfg.AddProfile<AdoptionProfile>();
    cfg.AddProfile<ChildOrphanageProfile>();
    cfg.AddProfile<AdoptionDetailProfile>();
});
