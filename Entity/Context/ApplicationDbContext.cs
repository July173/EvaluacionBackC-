...
namespace Entity.Context
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public DbSet<ChildOrphanage> ChildOrphanages { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Child-Orphanage relationship (many-to-many modeled as entity)
            modelBuilder.Entity<ChildOrphanage>()
                .HasOne(co => co.Child)
                .WithMany(c => c.ChildOrphanage)
                .HasForeignKey(co => co.child_id);

            modelBuilder.Entity<ChildOrphanage>()
                .HasOne(co => co.Orphanage)
                .WithMany(o => o.ChildOrphanage)
                .HasForeignKey(co => co.orphanage_id);

            // Adoption -> SocialWorker (many adoptions for one social worker)
            modelBuilder.Entity<Adoption>()
                .HasOne(a => a.SocialWorker)
                .WithMany(s => s.Adoptions)
                .HasForeignKey(a => a.socialworker_id);

            // AdoptionDetail relations: links Adoption, Parent and Child
            modelBuilder.Entity<AdoptionDetail>()
                .HasOne(ad => ad.Adoption)
                .WithMany(a => a.AdoptionDetails)
                .HasForeignKey(ad => ad.adoption_id);

            modelBuilder.Entity<AdoptionDetail>()
                .HasOne(ad => ad.Parent)
                .WithMany(p => p.AdoptionDetails)
                .HasForeignKey(ad => ad.parent_id);

            modelBuilder.Entity<AdoptionDetail>()
                .HasOne(ad => ad.Child)
                .WithMany(c => c.AdoptionDetails)
                .HasForeignKey(ad => ad.child_id);
